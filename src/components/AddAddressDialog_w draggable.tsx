...
const DraggableComponent = Draggable as unknown as ComponentType<any>;

const DraggablePaper = (props: PaperProps) => (
  <DraggableComponent
    handle="#add-address-dialog-title"
...
const AddAddressDialog = ({
  ...
  return (
    ...
    >
      <DialogTitle id="add-address-dialog-title" sx={{ cursor: 'move' }}>
